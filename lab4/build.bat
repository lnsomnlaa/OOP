@echo off
echo Building lab4 host (ShapesLab.exe) with MSVC...
...
cl /nologo /EHsc /Fe:ShapesLab.exe main.cpp ShapeList.cpp ShapeRenderer.cpp ShapeFactory.cpp Solid3D.cpp ^
   ShapeBinaryRegistry.cpp ShapeBinaryCodecs.cpp Lab3Dialogs.cpp HostServices.cpp PluginLoader.cpp PluginTrust.cpp ^
...
echo Building sample plugin (plugins\PluginStar\build_plugin.bat)...
call plugins\PluginStar\build_plugin.bat
if %ERRORLEVEL% neq 0 (
